...
<form id="form1" method="post" action="">
  ...
  <table width="995" height="141" border="2">
    <tr>
      <td height="133"><strong>In accordance with the provisions of section 7 (4th schedule) of the 1999 constitution of the Federal Republic of Nigeria; Federal Capital Territory Act Cap 503, LFN. 2004 (Vol. 3) as amended;  Taxes and Levies Act No. 21 of 1998 and A.M.A.C.Tenement Rate bye-Laws 2012, we forward herewith your bill for the year  <?php echo $row_notice['rate_year']; ?>, totaling =N=   <?php echo $row_notice['grand_total']; ?> in respect of the landed property(ies) you are occupying in Abuja as per details above.</strong>
      <p>&nbsp;</p></td>
    </tr>
  </table>
...
<table width="1023" height="276" border="0">
    <tr>
      <td width="576" height="272"><table width="575" height="263" border="0">
        <tr>
          <td width="569" height="237"><p><img src="signature.jpg" alt="sign" width="287" height="105" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src="MRADE.JPG" width="220" height="98"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br />
            <strong><font size="-1">
            HEAD OF TENEMENT RATE&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;DIRECTOR OF OPERATIONS</strong><br /><font size="-1">For: Honourable Chairman&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;For: Honourable Chairman<br />
            Abuja Municipal Area Council&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Abuja Municipal Area Council<br />
            </font><br />
            </p></td>
        </tr>
        <tr>
      ...
      <td width="437" height="272"><table width="425" height="138" border="1">
        <tr>
          <td width="188" height="57">DATE OF DESPATCH</td>
          <td width="221">&nbsp;</td>
        </tr>
        <tr>
