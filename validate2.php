...
if (isset($_POST['username'])) {
  ...
  $MM_redirectLoginSuccess = "dataform.php";
  ...
  <div id="content">
    <div class="post">
      <div class="entry">
        ...
        <p><em><strong><blink><font color= red>Wrong Username and/or Password please try again</font></blink></strong></em></p>
        <p><em><strong><blink></blink></strong></em>LOGIN TO INSERT DATA</p>
        <form id="form1" method="POST" action="<?php echo $loginFormAction; ?>">
          <p>User Name:
            <label for="username"></label>
            <input name="username" type="text" id="username" value="" size="45" />
          </p>
          <p>&nbsp;Password:
            <label for="password"></label>
            <input name="password" type="password" id="password" value="" size="45" />
          </p>
          <p> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
