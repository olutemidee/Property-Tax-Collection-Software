...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "newmember")) {
  $insertSQL = sprintf("INSERT INTO memeber_reg (DDC_Officer, pin, first_name, last_name, DOB, state_origin, lga, business_name, specialization, business_address, `phone number`, phone2, pasport_photo) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
    ...
    <div class="forms">
      <form action="<?php echo $editFormAction; ?>" method="post" enctype="multipart/form-data" id="newmember">
        <table width="485" border="0">
          ...
          <tr>
            <td>Date of Birth:
              <input name="dob" type="text" id="dob" size="40" /></td>
            <td>Phone 2:
          ...
          <tr>
            ...
            <td>Passport Photo:
              ...
              <input name="photo" type="file" id="photo2" size="28" /></td>
          </tr>
          <tr>
            <td>LGA:
              <input name="lga" type="text" id="lga" size="40" /></td>
            <td><input type="button" name="Button" id="button" value="Submit" onclick="javascript:sender()"/></td>
          </tr>
        </table>
        <p>
